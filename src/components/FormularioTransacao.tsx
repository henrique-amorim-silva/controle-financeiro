...
export const FormularioTransacao: React.FC<FormularioTransacaoProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onAdicionarTransacao({
      ...
      tipo,
      banco,
      categoria: categoria as CategoriaDespesa | CategoriaReceita,
  ...
  return (
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm dark:shadow-xl mb-8">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <select
            ...
            className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-slate-200 text-sm rounded-xl p-2.5 focus:ring-2 focus:ring-emerald-500 outline-none"
          >
        ...
        {/* Campo de Banco */}
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-medium text-slate-500 dark:text-slate-400">Banco / Conta</label>
          <select
            value={banco}
        ...
        {tipo === 'despesa' && (
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-medium text-slate-500 dark:text-slate-400">Classificação</label>
            <select
              value={tipoGasto}
        ...
        <div className="flex items-center gap-2 pt-6">
          ...
          />
          <label htmlFor="pago" className="text-sm text-slate-700 dark:text-slate-300 cursor-pointer">
